...
#ifndef PLAY_WITH_COROUTINES__STATES_HPP_
#define PLAY_WITH_COROUTINES__STATES_HPP_
...
template <typename F, typename SM, typename Sym>
...
auto state_machine<State, Sym>::get_awaiter(F transition) {
    return stm_awaiter<F, decltype(*this), Sym>(transition, *this);
}

#endif //PLAY_WITH_COROUTINES__STATES_HPP_
